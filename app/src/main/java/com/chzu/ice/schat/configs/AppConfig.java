...
public class AppConfig {
    public static final String SERVER_DEV = "http://192.168.50.70:18080/api";
    ...
    public static final String GET_ACCESS_TOKEN_API = SERVER_DEV + "/userAccount/getAccessToken";
