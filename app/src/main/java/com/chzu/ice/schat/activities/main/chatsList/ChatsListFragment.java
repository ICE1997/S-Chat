...
public class ChatsListFragment extends Fragment implements ChatsListContract.View {
    ...
    private void preInflateView() {
        new Handler().post(() -> {
            ...
            selectTV = bottomNavEdit.findViewById(R.id.tvSelect);
    ...
    private void chatListInit() {
        ...
        chatRCVAdapter.setListController(new ChatRCVAdapter.ListController() {
            @Override
    ...
    private final class OnChangeEditModeListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (!isEditMode) {
                isEditMode = true;
                final TextView selectAllTV = bottomNavEdit.findViewById(R.id.tvSelect);
